...
const config = {
  SESSION_ID: process.env.SESSION_ID || "NOVA-MD",
  PREFIX: process.env.PREFIX || '.',
   BOT_NAME: process.env.BOT_NAME || "NOVA-MD",
   BOT: process.env.BOT || "hello 👋",
  NEW_CMD: process.env.NEW_CMD || "ᴀᴅᴅᴠᴀʀ\n│ sᴜᴅᴏ\n| jon",
  CAPTION: process.env.CAPTION|| "ᴘᴏᴡᴇʀᴇᴅ ʙʏ jon-snow",
  ...
  STATUS_READ_MSG: process.env.STATUS_READ_MSG || 'Status Viewed by NOVA-MD',
  ...
  DELETED_MESSAGES_CHAT_ID: process.env.DELETED_MESSAGES_CHAT_ID || "50949100359@s.whatsapp.net",
  OWNER_NAME: process.env.OWNER_NAME || "enter your name here👈",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "50949100359",
  SUDO_NUMBER: process.env.SUDO_NUMBER || "50949100359",
